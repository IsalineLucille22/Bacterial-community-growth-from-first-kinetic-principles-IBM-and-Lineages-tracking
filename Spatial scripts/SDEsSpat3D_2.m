function [t, Nb_Cells_Evol, Pos_S, vect_Cell_lenght_tot, Mass_Cell_Evol, vect_angle_tot, Mass_Cell, num_col, Generation_tree, Mass_Res_Waste_Evol, rho_vect, mu_evol, lag_time, bbRegion, mu_max_cell_init, rho_3D_tot, Vect_Time_saved] = ...
    SDEsSpat3D_2(Data, vect_species, T_fin, t_D, Diff_Coeff, t_Diff, dx, dy, Time_forces, Time_saved, length_cell, height_cell, Mass_S_0, Mass_Resource, Mass_Vol, Vol_Box, lz, Threshold_divide, Threshold_Res, vect_rate, std_mu_max, fact_mod_mu, shrink_rate, mat_Pred, Coeff_Browian, Pos_Resource, Pos_S_0, dim_Img)

%in this script 'fact_mod_mu' is used to change the yield of an individual cell
...
%%%%If a umax factor is considered - here to change the yield

yield_temp = kappa_2./(kappa_2 + kappa_3);%kappa_2./(kappa_2 + kappa_3).*fact_mod_mu';
...
%kappa_2 = mu_max_cell.*fact_mod_mu';
for j = 1:N_Fin_iter
