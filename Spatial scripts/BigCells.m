...
%Script used when we want to adapt resource box size to cell size. For
%instance, if small resource box, this script will be used to split the
%cell according the the resource box when its size is larger than a
%resource box side.
